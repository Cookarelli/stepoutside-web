...
const poorAccuracy = point(42.27056, -89.0940, 6_000, 50);
...
assert(!jitterResult.accepted && jitterResult.reason === "too_close", "tiny jitter should be ignored");
...
assert.equal(formatWalkingPace(20, 30), null, "pace should stay hidden during calibration");
